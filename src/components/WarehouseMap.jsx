...
export function WarehouseMap({ products, onSelectProductForZebra, onGoToZebra }) {
  ...
  const BIN_DEFINITIONS = [
    ...
    // PISO 3
    { id: "COTA-PISO-3", rack: "PISO", rackName: "Piso 3", tier: 1, tierName: "Piso 3 • Contratos", capacity: 150, color: "#D97706" }
  ];
    ...
    products.forEach(p => {
      ...
      if (!map[bId]) {
        map[bId] = {
          ...
          rackName: bId.includes("A") ? "Estante A" : bId.includes("B") ? "Estante B" : bId.includes("C") ? "Estante C" : "Piso 3",
          tier: 1,
          tierName: bId,
          capacity: 150,
          color: "#2563EB",
  ...
  const racks = [
    ...
    { key: "PISO", name: "Piso 3", levelsLabel: "Lotes Contractuales", subtitle: "Lotes Contractuales HP / Kyocera", color: "#D97706", borderColor: "#D97706", bins: ["COTA-PISO-3"] }
  ];
